...
#NOTE: Apologies for the long HTML file! Please scroll down to see my answers.  Thank you!
...
```{r HW3 questions}
#Question 1
newDepData = filter(flightd, is.na(dep_time))
str(newDepData)
#dep_delay, arr_time, arr_delay, and air_time are also missing.  These rows probably represent canceled flights.

#Question 2
newFlightd = mutate(flightd, "temp_value" = (dep_time/100) * 60, "adjuster" = (dep_time %% 100) * 60,
                    "additional_minutes" = dep_time %% 100, "total_minutes" = temp_value - adjuster + additional_minutes)
