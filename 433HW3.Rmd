...
#NOTE: Apologies for the long HTML file! Please scroll down to see my answers.  Thank you!  Here is 
#the link to the GitHub repository:  https://github.com/samg453/myrepo/blob/main/433HW3.Rmd
...
```{r HW3 questions}
#Question 1
newDepData = filter(flights, is.na(dep_time))
str(newDepData)
#dep_delay, arr_time, arr_delay, and air_time are also missing.  These rows probably represent canceled flights.

#Question 2
#Some funky operations, but I'm pretty sure they work.
flights %>%
  mutate(temp_value = ((dep_time/100) * 60) - (((dep_time %% 100)/100) * 60) + 
           (dep_time %% 100))

#Question 3
#This section of code finds the average delay per day.  This code section is courtesy of
#our textbook, r4ds.
delay_average_day <- group_by(flights, year, month, day)
summarise(delay_average_day, delay = mean(dep_delay, na.rm = TRUE))

#In this short section of code below, I am trying to find the average number of 
#canceled flights per day.
canceled_per_day <- group_by(newDepData, year, month, day)
summarise(canceled_per_day, canceled = mean(dep_time, na.rm = TRUE))

ggplot(x = delay_average_day, y = canceled_per_day) + geom_point()
#Although this code does not completely work properly, in the interest of answering the homework question
#I will use intuition and say that yes, the proportion of canceled flights is related to the average delay.

#Just to make sure I make it clearly visible, here again is 
#the link to the GitHub repository:  https://github.com/samg453/myrepo/blob/main/433HW3.Rmd
```
